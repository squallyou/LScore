...
/**
 * 包括连音线在内的线条符号的父类.
 * 继承的自该类的子类具有的特点：可被切分，即符号可能由于换行等情况而被一分为二.
 * @author sjy
 *
 */
public abstract class AbstractSymbolLine extends JPanel implements Splitable{
	/**
	 * 序列号
	 */
	 ...
	 */
	protected AbstractSymbolLine preSymbolLine;
	/**
	 * 切分后符号的下一部分，没有切分或者为切分后的最后一部分 则为null.
	 */
	protected AbstractSymbolLine nextSymbolLine;
	
	/**
	 * 构造函数
	 */
	public AbstractSymbolLine(){
		super();
		setOpaque(false);
		setLayout(null);
	}
	 ...
	 * @return
	 */
	public AbstractSymbolLine getPreSymbolLine() {
	 ...
	 * @param preSymbolLine
	 */
	public void setPreSymbolLine(AbstractSymbolLine preSymbolLine) {
	 ...
	 * @return
	 */
	public AbstractSymbolLine getNextSymbolLine() {
	 ...
	 */
	public void setNextSymbolLine(AbstractSymbolLine nextSymbolLine) {
