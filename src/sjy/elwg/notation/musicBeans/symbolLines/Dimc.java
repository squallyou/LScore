...
public class Dimc extends SymbolLine {

	/**
	 * 序列号
	 */
	private static final long serialVersionUID = -6479160996185269666L;
	/**
	 * 高度
	 */
	public static final int DIMC_HEIGHT = 23;
	/**
	 * 默认宽度
	 */
	public static final int  DIMC_WIDTH= 30;
	
	/**
	 * 根据起始音符构造符号
	 * @param note
	 */
	public Dimc(AbstractNote note){
		super();
		startNote = note;
		if(note != null)
	 ...
	 * @param enote
	 */
	public Dimc(AbstractNote snote , AbstractNote enote){
		super();
		startNote = snote;
		endNote = enote;
		if(snote != null)
	...
	public void reSize(int x) {
		// TODO Auto-generated method stub
		if(x < DIMC_WIDTH){
			setSize(DIMC_WIDTH, DIMC_HEIGHT);
		}else{
			setSize(x, DIMC_HEIGHT);
		}
	...
	public void paintComponent(Graphics gg){
		...
		g.drawString("diminuendo", 0, Note.HEAD_HEIGHT);
//		int x = 35;
//		if(status == EDIT_STATUS){
//			if (x < getWidth()) {
//				while(x < getWidth()){
